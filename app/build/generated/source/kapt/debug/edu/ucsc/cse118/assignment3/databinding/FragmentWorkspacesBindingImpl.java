...
public class FragmentWorkspacesBindingImpl extends FragmentWorkspacesBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            ...
            setWorkspacesFragment((edu.ucsc.cse118.assignment3.ui.workspaces.WorkspacesFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setWorkspacesFragment(@Nullable edu.ucsc.cse118.assignment3.ui.workspaces.WorkspacesFragment WorkspacesFragment) {
