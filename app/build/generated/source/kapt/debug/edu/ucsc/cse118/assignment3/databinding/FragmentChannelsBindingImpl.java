...
public class FragmentChannelsBindingImpl extends FragmentChannelsBinding  {
    ...
    public FragmentChannelsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private FragmentChannelsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.channelsFragment == variableId) {
            setChannelsFragment((edu.ucsc.cse118.assignment3.ui.channels.ChannelsFragment) variable);
        }
    ...
    public void setChannelsFragment(@Nullable edu.ucsc.cse118.assignment3.ui.channels.ChannelsFragment ChannelsFragment) {
